...
const firebaseConfig = {
    apiKey: "AIzaSyCWRjAglK9UcYvMn1PNqgOyiDdLrWPzuYE",
    authDomain: "digitalisasipkd.firebaseapp.com",
    projectId: "digitalisasipkd",
    storageBucket: "digitalisasipkd.appspot.com",
    messagingSenderId: "400107328016",
    appId: "1:400107328016:web:851371332a24ea4ecf7095"
};
...
const rindirCard = (data) => {
    ...
    <div class="card-body bg-light shadow p-3 m-0 rounded-4" id="${data.id}">
        <div class="d-flex flex-wrap justify-content-between align-items-center">
            <p class="text-dark text-truncate m-0 p-0" style="font-size: 0.95rem;">
                <strong class="me-1" style="color: #900d09;">${data.nama}</strong>
            </p>
        </div>
        <hr class="text-dark my-1">
...
export const kirimUcapan = async () => {
    ...
    if (komentar.length >= 3000) {
        alert('Panjang maksimal 3000 karakter');
        return;
    }
    // if (hadir == 0) {
